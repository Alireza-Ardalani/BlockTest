...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        case08_SimpleExecutorInterface();
        case08_SimpleExecutorInterface();
    ...
    // case08: Executor simpleExecutor.execute(Runnable) via Executor interface
    private void case08_SimpleExecutorInterface() {
        simpleExecutor.execute(new Runnable() {
            @Override
            public void run() {
                IOBlockingCall("case08-simple-executor-interface");
            }
        });
    }
